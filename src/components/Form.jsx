...
const Form = () => {
  ...
  const [changeImageType, setChangeImageType] = React.useState(false);
  ...
  const updateCurrentPost = async (values) => {
    let postUpdate = {
      title: values.title,
      category: values.category,
      content: values.content,
    ...
    if (cover && stateFile !== post.fileRef) {
        ...
        <>
          ...
          <div className='form-post'>
            <div className='container'>
              ...
              <Formik
                initialValues={{
                  stateFile: isEdit ? post.fileRef : stateFile,
                  cover: isEdit ? post.cover : cover,
                  title: isEdit ? post.title : '',
                  category: isEdit ? post.category : '',
                  content: isEdit ? post.content : '',
                }}
                validationSchema={Yup.object({
                  cover: changeImageType
                    ? Yup.mixed()
                ...
                onSubmit={(values) => {
                  isEdit ? updateCurrentPost(values) : addPost(values);
                }}>
                {(props) => (
                  <form onSubmit={props.handleSubmit}>
                    <div id='input__image'>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(event) => {
                            ...
                            props.setFieldValue('stateFile', fileUploaded.name);
                            props.setFieldValue('cover', fileUploaded);
                          }}
                      ...
                      <span id='file-chosen'>
                        {isEdit ? (stateFile ? stateFile : post.fileRef) : stateFile ? stateFile : 'No file chosen'}
                      </span>
                      <div>
                    ...
                    <div className='input'>
                      ...
                      {props.touched.title && props.errors.title ? <div className='input__error'>{props.errors.title}</div> : null}
                    </div>
                    ...
                    <div className='input'>
                      ...
                      {props.touched.category && props.errors.category ? <div className='input__error'>{props.errors.category}</div> : null}
                    </div>
                    ...
                    <div className='input'>
                      ...
                      {props.touched.content && props.errors.content ? <div className='input__error'>{props.errors.content}</div> : null}
                    </div>
                    ...
                    <div className='input__buttons'>
                      ...
                      <input
                        ...
                        onClick={isEdit ? null : () => setChangeImageType(true)}
                      />
                    </div>
                  </form>
                )}
